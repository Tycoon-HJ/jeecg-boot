<template>
  <div>
   ...
   <BasicTable @register="registerTable" :rowSelection="rowSelection">
    ...
    <!-- 表单区域 -->
    <YsjFieldManageModal @register="registerModal" @success="handleSuccess"></YsjFieldManageModal>
  </div>
</template>
...
<script lang="ts" name="ysjFieldManage-ysjFieldManage" setup>
  ...
  import {columns, searchFormSchema, superQuerySchema} from './YsjFieldManage.data';
